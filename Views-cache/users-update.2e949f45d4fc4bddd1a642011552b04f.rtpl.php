        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="/Adm/users/<?php echo htmlspecialchars( $user["idusuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
                        <div class="box-body">
                            <input name="idusuario" type="hidden" value="<?php echo htmlspecialchars( $user["idusuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            <div class="form-group">
                                <label for="desperson">Nome</label>
                                <input type="text" class="form-control" id="desperson" name="despessoas" placeholder="Digite o nome" value="<?php echo htmlspecialchars( $user["despessoas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            </div>
                            <div class="form-group">
