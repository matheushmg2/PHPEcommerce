                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <?php if( verificaLogin(false) ){ ?>
                            <li><a href="/profile"><i class="fa fa-user"></i> <?php echo getNomeUsuario(); ?></a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - <span class="cart-amunt">R$<?php echo getCarrinhoSubTotal(); ?></span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?php echo getCarrinhoQnt(); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
