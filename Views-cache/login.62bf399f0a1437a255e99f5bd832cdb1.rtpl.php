    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <?php if( $MsgErrorRegistros != '' ){ ?>

                <div class="alert alert-danger">
                    <?php echo htmlspecialchars( $MsgErrorRegistros, ENT_COMPAT, 'UTF-8', FALSE ); ?>
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
                    ...
                    <p class="form-row form-row-first">
                        ...
                        <input type="text" id="nome" name="nome" class="input-text" value="<?php echo htmlspecialchars( $registrosValores["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
                        <label for="login">Login <span class="required">*</span>
                        </label>
                        <input type="text" id="login" name="login" class="input-text" value="<?php echo htmlspecialchars( $registrosValores["login"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-last">
                        <label for="senha">Senha <span class="required">*</span>
                        </label>
                    ...
                    <p class="form-row form-row-first">
                        ...
                        <input type="email" id="email" name="email" class="input-text" value="<?php echo htmlspecialchars( $registrosValores["email"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
                        <label for="phone">Telefone
                        </label>
                        <input type="text" id="phone" name="phone" class="input-text" value="<?php echo htmlspecialchars( $registrosValores["phone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <div class="clear"></div>
